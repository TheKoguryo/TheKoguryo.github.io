...
- **OCI Kubernetes Engine(OKE) 쿠버네티스 프로세스 로그**
...
11. OCI 콘솔에서 IAM에서 확인해 보면, 아래와 같이 Dynamic Group 및 Policy이 만들어집니다. Log & Object Collection Pods가 있는 Worker Nodes 그룹에게 OCI Logging Analytics에 로그를 업로드할 권한을 부여합니다.
     ...
     - OCI 콘솔에서 [Default Identity Domain](https://cloud.oracle.com/identity/domains)을 선택하여, Dynamic Group을 확인해 봅니다.
...
12. 로그 수집을 위한 OCI Logging Group과 OCI Logging, Connector Hub도 함께 생성됩니다. 전체 생성되는 자원 내역은 [Resource Manager](https://cloud.oracle.com/resourcemanager/stacks)에서 생성된 Stack resources로 확인하기 바랍니다.
...
6. 클라스터상의 수집된 컨테이너 로그들을 볼 수 있습니다.
