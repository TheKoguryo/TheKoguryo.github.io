...
1. Oracle AI Database 26ai가 Vector Store로서 제공하는 주요 기능 소개
...
* Oracle AI Database 26ai Vector Search의 Vector Store로서의 주요 기능
* Python/LangChain에서 RAG 구현시 Vector Store로 Oracle AI Database 26ai 사용 하기
