...
3. 차트 배포시 values.yaml 파일로 커스터마이징할 수 있습니다. values.yaml 중 ingress 관련 행에 OCI에 맞게 Flexible Load Balancer를 쓰도록 미리 설정해 두었습니다.

    ````shell
    $ sed -n '30,43p' deploy/complete/helm-chart/setup/values.yaml 
...
8. Persistent Volume 사용 조회

    ```shell
    $ kubectl get sc
    NAME               PROVISIONER                       RECLAIMPOLICY   VOLUMEBINDINGMODE      ALLOWVOLUMEEXPANSION   AGE
    oci                oracle.com/oci                    Delete          Immediate              false                  4h6m
    oci-bv (default)   blockvolume.csi.oraclecloud.com   Delete          WaitForFirstConsumer   true                   4h6m

    $ kubectl get pvc -A
    NAMESPACE          NAME                                  STATUS   VOLUME                                     CAPACITY   ACCESS MODES   STORAGECLASS   VOLUMEATTRIBUTESCLASS   AGE
    mushop-utilities   mushop-utils-grafana                  Bound    csi-fa898435-4453-46ac-aab1-d61a16d3c089   50Gi       RWO            oci-bv         <unset>                 24m
    mushop-utilities   mushop-utils-prometheus-server        Bound    csi-a2e8fa21-6e19-4836-81d0-9c2a16cce599   50Gi       RWO            oci-bv         <unset>                 24m
    mushop-utilities   storage-mushop-utils-alertmanager-0   Bound    csi-d16fc388-b865-4358-b797-981d82ac744b   50Gi       RWO            oci-bv         <unset>                 56m

    $ kubectl get pv -A
    NAME                                       CAPACITY   ACCESS MODES   RECLAIM POLICY   STATUS   CLAIM                                                  STORAGECLASS   VOLUMEATTRIBUTESCLASS   REASON   AGE
    csi-a2e8fa21-6e19-4836-81d0-9c2a16cce599   50Gi       RWO            Delete           Bound    mushop-utilities/mushop-utils-prometheus-server        oci-bv         <unset>                          24m
    csi-d16fc388-b865-4358-b797-981d82ac744b   50Gi       RWO            Delete           Bound    mushop-utilities/storage-mushop-utils-alertmanager-0   oci-bv         <unset>                          56m
    csi-fa898435-4453-46ac-aab1-d61a16d3c089   50Gi       RWO            Delete           Bound    mushop-utilities/mushop-utils-grafana                  oci-bv         <unset>                          24m
    ```
